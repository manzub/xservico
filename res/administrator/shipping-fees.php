...
if(isset($_POST['update'])) {
    $activity = "Attempted update on Shipping & Delivery Details info.";
    ...
    if(!password_verify($password, $acct_password)) {
        ...
        otherQuery("update pages set info='$info', date_modified='$date' where type='shipping'");

        $activity = "Shipping & Delivery Details update was successful.";
        createLog(getUserID($_SESSION['xservico_slug'][0]), $activity);
        $success = "Shipping & Delivery Details was updated successfully!";
    }
}


$query = selectQuery("select * from pages where type = 'shipping'");
while($row=mysqli_fetch_assoc($query)){
    $info = $row['info'];
...
<head>
    <meta charset="utf-8" />
    <title>Shipping & Delivery | Xservico Online Store</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END THEME PANEL -->
            <h1 class="page-title">Shipping & Delivery</small>
            </h1>
            <div class="page-bar">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> Manage Shipping & Delivery Information</span>
                            </div>
                        </div>
