...
if(isset($_POST['update'])) {
    $activity = "Attempted update on Privacy Policy info.";
    ...
    if(!password_verify($password, $acct_password)) {
        ...
        otherQuery("update pages set info='$info', date_modified='$date' where type='privacy_policy'");

        $activity = "Terms of Use update was successful.";
        createLog(getUserID($_SESSION['xservico_slug'][0]), $activity);
        $success = "Terms of Use was updated successfully!";
    }
}

$query = selectQuery("select * from pages where type = 'privacy_policy'");
while($row=mysqli_fetch_assoc($query)){
    $info = $row['info'];
...
<head>
    <meta charset="utf-8" />
    <title>Privacy Policy | Xservico Online Store</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END THEME PANEL -->
            <h1 class="page-title"> Privacy Policy</small>
            </h1>
            <div class="page-bar">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> Manage Privacy Policy Information</span>
                            </div>
                        </div>
