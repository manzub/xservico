...
if(isset($_POST['update'])) {
    $activity = "Attempted update on Order Cancellation info.";
    ...
    if(!password_verify($password, $acct_password)) {
        ...
        otherQuery("update pages set info='$info', date_modified='$date' where type='order_cancellation'");

        $activity = "Order Cancellation update was successful.";
        createLog(getUserID($_SESSION['xservico_slug'][0]), $activity);
        $success = "Order Cancellation was updated successfully!";
    }
}

$query = selectQuery("select * from pages where type = 'order_cancellation'");
while($row=mysqli_fetch_assoc($query)){
    $info = $row['info'];
...
<head>
    <meta charset="utf-8" />
    <title>Order Cancellation | Xservico Online Store</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END THEME PANEL -->
            <h1 class="page-title"> Order Cancellation</small>
            </h1>
            <div class="page-bar">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> Manage Order Cancellation Information</span>
                            </div>
                        </div>
