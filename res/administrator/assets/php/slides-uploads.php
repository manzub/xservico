...
if (! empty($_FILES)) {
    ...
    if(isset($_FILES["file"]) && $_FILES["file"]['size']>0){
        ...
        if($_FILES["file"]['size']>5000000){
            ...
            define("UPLOAD_DIR", "assets/images/main-sliders/");
            $image = $_FILES["file"];
            ...
            if (!isset($success)) {
                ...
                otherQuery("insert into sliders (image, main_title, sub_title, link, price, previous, date_posted) values ('$image','$main_title','$sub_title','$link','$price','$previous','$date')");
            }
        }
    }
}
