...
if(isset($_POST['update'])) {
    ...
    if(!password_verify($password, $acct_password)) {
        ...
        otherQuery("update pages set info='$info', date_modified='$date' where type='terms_use'");
...
$query = selectQuery("select * from pages where type = 'terms_use'");
while($row=mysqli_fetch_assoc($query)){
    $info = $row['info'];
...
<head>
    <meta charset="utf-8" />
    <title>Terms of Use | Xservico Online Store</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END THEME PANEL -->
            <h1 class="page-title"> Terms of Use</small>
            </h1>
            <div class="page-bar">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> Manage Terms of Use Information</span>
                            </div>
                        </div>
